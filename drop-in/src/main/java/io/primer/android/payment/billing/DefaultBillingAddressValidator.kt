...
private fun errorResIdBy(inputType: PrimerInputElementType): Int =
    when (inputType) {
...
@Suppress("ComplexMethod")
private fun errorIdBy(inputType: PrimerInputElementType): String =
    when (inputType) {
...
@Suppress("ComplexMethod")
private fun fieldIdBy(inputType: PrimerInputElementType): Int =
    when (inputType) {
