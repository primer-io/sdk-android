...
class PhoneNumberLocalFormDataSourceTest {
    ...
    @Test
    fun `get() returns correct FormDataResponse for ADYEN_MBWAY in dark mode`() = runTest {
    ...
    @Test
    fun `get() returns correct FormDataResponse for ADYEN_MBWAY in light mode`() = runTest {
    ...
    @Test
    fun `get() returns correct FormDataResponse for XENDIT_OVO in dark mode`() = runTest {
        every { theme.isDarkMode } returns true
        val phoneCode = mockk<PrimerPhoneCode>()
    ...
    @Test
    fun `get() returns correct FormDataResponse for XENDIT_OVO in light mode`() = runTest {
        every { theme.isDarkMode } returns false
        val phoneCode = mockk<PrimerPhoneCode>()
        every { countriesRepository.getPhoneCodeByCountryCode(CountryCode.ID) } returns phoneCode
    ...
    @Test
    fun `get() emits error for unsupported payment method type`() = runTest {
        every { theme.isDarkMode } returns true
