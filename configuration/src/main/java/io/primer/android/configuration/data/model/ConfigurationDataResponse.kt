...
import io.primer.android.configuration.data.model.CheckoutModuleDataResponse.Companion.REQUEST_URL_FIELD
import io.primer.android.configuration.data.model.CheckoutModuleDataResponse.Companion.TYPE_FIELD
...
import io.primer.android.core.data.serialization.json.extensions.optNullableObject
...
data class ConfigurationDataResponse(
    val pciUrl: String,
    val coreUrl: String,
...
enum class PaymentMethodImplementationType {
    NATIVE_SDK,
    WEB_REDIRECT,
    IPAY88_SDK,
    UNKNOWN,
