...
class AdyenBancontactTokenizationDelegateTest {
    ...
    private val input = AdyenBancontactTokenizationInputable(
    ...
    private val adyenBancontactConfig = AdyenBancontactConfig(
    ...
    fun setUp() {
        ...
        delegate = AdyenBancontactTokenizationDelegate(
    ...
    fun `mapTokenizationData returns success result when the configurationInteractor returns Result success`() = runTest {
        ...
        coEvery { configurationInteractor(adyenBancontactConfigParams) } returns Result.success(adyenBancontactConfig)
