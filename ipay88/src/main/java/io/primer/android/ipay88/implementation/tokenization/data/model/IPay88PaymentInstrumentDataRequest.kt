...
internal data class IPay88PaymentInstrumentDataRequest(
    ...
    companion object {
        ...
        @JvmField
        val serializer = JSONObjectSerializer<IPay88PaymentInstrumentDataRequest> { t ->
            JSONObject().apply {
                ...
                put(
                    ...
                    JSONSerializationUtils
                        .getJsonObjectSerializer<IPay88SessionInfoDataRequest>()
