...
class KlarnaCustomerTokenDataRepositoryTest {
    ...
    @Test
    fun `createCustomerToken() should return response when data source call succeeds`() = runTest {
        ...
        val currency = "euro"
        val order = mockk<OrderDataResponse> {
    ...
    @Test
    fun `createCustomerToken() should return SessionCreateException when data source call throws client error HttpException`() = runTest {
        val sessionId = "sessionId"
        val authorizationToken = "authorizationToken"
        val params = mockk<KlarnaCustomerTokenParam> {
            every { this@mockk.sessionId } returns sessionId
    ...
    @Test
    fun `createCustomerToken() should return exception when data source call throws client error`() = runTest {
        val sessionId = "sessionId"
        val authorizationToken = "authorizationToken"
        val params = mockk<KlarnaCustomerTokenParam> {
            every { this@mockk.sessionId } returns sessionId
