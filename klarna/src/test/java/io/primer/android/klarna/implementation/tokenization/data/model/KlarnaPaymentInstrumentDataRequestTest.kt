...
internal class KlarnaPaymentInstrumentDataRequestTest {
    ...
    private val tokenDetails = TokenDetailsData(
        brand = "VISA",
        maskedNumber = "**** **** **** 1234",
        type = "credit",
        expiryDate = "12/23"
    ...
    private val sessionData = KlarnaSessionData(
    ...
    @Test
    fun `serializer should correctly serialize KlarnaCheckoutPaymentInstrumentDataRequest`() {
        // Given
        val dataRequest = KlarnaCheckoutPaymentInstrumentDataRequest(
        ...
        // When
        val actualJson = KlarnaPaymentInstrumentDataRequest.serializer.serialize(dataRequest)
