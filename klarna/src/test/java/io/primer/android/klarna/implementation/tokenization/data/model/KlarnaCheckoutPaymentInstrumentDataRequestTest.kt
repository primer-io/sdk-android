...
internal class KlarnaCheckoutPaymentInstrumentDataRequestTest {
    ...
    fun `serializer should correctly serialize KlarnaCheckoutPaymentInstrumentDataRequest`() {
        ...
        val expectedJson = JSONObject().apply {
            putOpt("klarnaAuthorizationToken", "auth-token")
            put(
                "sessionData",
                JSONObject().apply {
                    putOpt(
        ...
        // When
        val actualJson = KlarnaCheckoutPaymentInstrumentDataRequest.serializer.serialize(dataRequest)
