...
internal class RemoteKlarnaVaultPaymentSessionDataSource(
...
) : BaseSuspendDataSource<CreateSessionDataResponse, BaseRemoteHostRequest<CreateVaultPaymentSessionDataRequest>> {
    override suspend fun execute(
        ...
        primerHttpClient.withTimeout(PRIMER_60S_TIMEOUT)
            .suspendPost<CreateVaultPaymentSessionDataRequest, CreateSessionDataResponse>(
