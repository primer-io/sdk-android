...
internal class RemoteKlarnaCheckoutPaymentSessionDataSource(
...
) : BaseSuspendDataSource<CreateSessionDataResponse, BaseRemoteHostRequest<CreateCheckoutPaymentSessionDataRequest>> {
    override suspend fun execute(
        ...
        primerHttpClient.withTimeout(PRIMER_60S_TIMEOUT)
            .suspendPost<CreateCheckoutPaymentSessionDataRequest, CreateSessionDataResponse>(
