...
internal class KlarnaTokenizationParamsMapper :
    ...
    override fun map(params: TokenizationParams<KlarnaPaymentInstrumentParams>):
        TokenizationRequestV2<KlarnaPaymentInstrumentDataRequest> {
        val instrumentDataRequest = when (params.paymentInstrumentParams) {
            is KlarnaCheckoutPaymentInstrumentParams -> {
                val paymentInstrumentParams = params.paymentInstrumentParams as KlarnaCheckoutPaymentInstrumentParams
