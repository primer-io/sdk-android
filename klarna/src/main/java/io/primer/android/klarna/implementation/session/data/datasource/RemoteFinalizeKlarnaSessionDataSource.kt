...
internal class RemoteFinalizeKlarnaSessionDataSource(
...
) : BaseSuspendDataSource<FinalizeKlarnaSessionDataResponse, BaseRemoteHostRequest<FinalizeKlarnaSessionDataRequest>> {
    override suspend fun execute(
        ...
        primerHttpClient
            ...
            .suspendPost<FinalizeKlarnaSessionDataRequest, FinalizeKlarnaSessionDataResponse>(
