...
internal class GooglePayConfigurationDataRepositoryTest {
    ...
    @Test
    fun `getPaymentMethodConfiguration should return GooglePayConfiguration with valid data`() = runBlocking {
        // Given
        val paymentMethodRemoteConfigOptions = mockk<PaymentMethodRemoteConfigOptions> {
        ...
        val orderResponse = mockk<OrderDataResponse> {
        ...
        // Then
        val expected = GooglePayConfiguration(
    ...
    @Test
    fun `getPaymentMethodConfiguration should return GooglePayConfiguration with filtered card networks`() = runBlocking {
        // Given
        val paymentMethodRemoteConfigOptions = mockk<PaymentMethodRemoteConfigOptions> {
            every { merchantId } returns "testMerchantId"
        }
        ...
        val clientSessionDataResponse = mockk<ClientSessionDataResponse> {
            every { order } returns orderResponse
            every { paymentMethod } returns mockk {
                every { orderedAllowedCardNetworks } returns listOf(
    ...
    @Test
    fun `getPaymentMethodConfiguration should throw exception if merchantId is null`() = runBlocking {
        // Given
        val paymentMethodConfig = mockk<PaymentMethodConfigDataResponse> {
            every { type } returns PaymentMethodType.GOOGLE_PAY.name
