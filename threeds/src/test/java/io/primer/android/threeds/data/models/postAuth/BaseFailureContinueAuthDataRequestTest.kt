...
internal class BaseFailureContinueAuthDataRequestTest {
    ...
    @Test
    fun `toContinueAuthDataRequest(ThreeDsChallengeInvalidStatusError) should map to ChallengeRuntimeContinueAuthErrorDataRequest error`() {
        val error = mockk<ThreeDsError.ThreeDsChallengeInvalidStatusError>(relaxed = true)
        val params = mockk<FailureThreeDsContinueAuthParams>(relaxed = true)
