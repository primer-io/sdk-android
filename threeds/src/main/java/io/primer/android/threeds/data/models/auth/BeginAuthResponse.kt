...
internal data class BeginAuthResponse(
    ...
    companion object {
        ...
        val deserializer = JSONObjectDeserializer { t ->
            BeginAuthResponse(
                token = JSONSerializationUtils.getJsonObjectDeserializer<PaymentMethodTokenInternal>()
                    .deserialize(
                        t.getJSONObject(
                            TOKEN_FIELD
                        )
                    ),
                authentication = JSONSerializationUtils.getJsonObjectDeserializer<AuthenticationDataResponse>()
                    .deserialize(
                        t.getJSONObject(
