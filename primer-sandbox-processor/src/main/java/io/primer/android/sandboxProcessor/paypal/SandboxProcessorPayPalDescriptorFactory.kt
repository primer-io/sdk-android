...
internal class SandboxProcessorPayPalDescriptorFactory : PaymentMethodDescriptorFactory {
    ...
    ): PaymentMethodDescriptor = SandboxProcessorPayPalPaymentMethodDescriptor(localConfig, paymentMethodRemoteConfig)
}
