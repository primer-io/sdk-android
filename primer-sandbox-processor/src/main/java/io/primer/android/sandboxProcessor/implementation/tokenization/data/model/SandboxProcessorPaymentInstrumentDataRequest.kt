...
internal data class SandboxProcessorPaymentInstrumentDataRequest(
    val paymentMethodType: String,
    val paymentMethodConfigId: String,
    val sessionInfo: SandboxProcessorSessionInfoDataRequest,
    ...
    companion object {
        ...
        @JvmField
        val serializer = JSONObjectSerializer<SandboxProcessorPaymentInstrumentDataRequest> { t ->
            JSONObject().apply {
                ...
                put(
                    ...
                    JSONSerializationUtils
                        .getJsonObjectSerializer<SandboxProcessorSessionInfoDataRequest>()
