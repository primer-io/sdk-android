...
internal class RetailerOutletInputValidatorTest {
    ...
    @Test
    fun `validate should return no errors for valid input`() = runTest {
        val validRetailerData = PrimerRetailerData(id = "valid_id")
        val retailOutlet = mockk<RetailOutlet> {
    ...
    @Test
    fun `validate should return errors for invalid input`() = runTest {
