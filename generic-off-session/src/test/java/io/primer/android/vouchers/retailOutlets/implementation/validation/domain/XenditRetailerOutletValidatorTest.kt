...
internal class XenditRetailerOutletValidatorTest {
    ...
    @Test
    fun `validate should return error for null input`() =
        runTest {
    ...
    @Test
    fun `validate should return error for blank input`() =
        runTest {
    ...
    @Test
    fun `validate should return error for invalid retailer ID`() =
        runTest {
            val invalidRetailerId = "invalid_id"
            coEvery { retailOutletRepository.getCachedRetailOutlets() } returns
                listOf(
    ...
    @Test
    fun `validate should return null for valid retailer ID`() =
        runTest {
