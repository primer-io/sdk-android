...
class PhoneNumberValidatorTest {
    ...
    @Test
    fun `validate should return empty list when phone metadata is valid`() = runTest {
    ...
    @Test
    fun `validate should return validation error when PhoneValidationException is thrown`() = runTest {
        val phoneNumberData = PrimerPhoneNumberData(phoneNumber = "+351123456789")
    ...
    @Test
    fun `validate should rethrow exception when non-PhoneValidationException is thrown`() = runTest {
        val phoneNumberData = PrimerPhoneNumberData(phoneNumber = "+351123456789")
