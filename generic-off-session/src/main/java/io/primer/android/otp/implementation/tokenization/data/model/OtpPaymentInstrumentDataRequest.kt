...
internal data class OtpPaymentInstrumentDataRequest(
    val paymentMethodType: String,
    val paymentMethodConfigId: String,
    val sessionInfo: OtpSessionInfoDataRequest,
    ...
    companion object {
        ...
        @JvmField
        val serializer = JSONObjectSerializer<OtpPaymentInstrumentDataRequest> { t ->
            JSONObject().apply {
                ...
                put(SESSION_INFO_FIELD, t.sessionInfo.serialize())
            }
        }
    }
}
