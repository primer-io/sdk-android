...
internal data class QrCodePaymentInstrumentDataRequest(
    ...
    companion object {
        ...
        @JvmField
        val serializer = JSONObjectSerializer<QrCodePaymentInstrumentDataRequest> { t ->
            JSONObject().apply {
                ...
                put(
                    ...
                    JSONSerializationUtils
                        .getJsonObjectSerializer<QrCodeSessionInfoDataRequest>()
