...
internal class RetailOutletsRemoteTokenizationDataSource(
    primerHttpClient: PrimerHttpClient,
    apiVersion: () -> PrimerApiVersion,
) : BaseRemoteTokenizationDataSource<RetailOutletsPaymentInstrumentDataRequest>(primerHttpClient, apiVersion)
