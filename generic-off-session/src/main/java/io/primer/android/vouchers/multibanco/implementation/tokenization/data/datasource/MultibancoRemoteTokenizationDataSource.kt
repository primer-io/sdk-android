...
internal class MultibancoRemoteTokenizationDataSource(
    primerHttpClient: PrimerHttpClient,
    apiVersion: () -> PrimerApiVersion,
) : BaseRemoteTokenizationDataSource<MultibancoPaymentInstrumentDataRequest>(primerHttpClient, apiVersion)
