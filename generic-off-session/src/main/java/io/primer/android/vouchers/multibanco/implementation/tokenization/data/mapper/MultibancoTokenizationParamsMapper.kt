...
internal class MultibancoTokenizationParamsMapper :
    ...
    override fun map(params: TokenizationParams<MultibancoPaymentInstrumentParams>):
        TokenizationRequestV2<MultibancoPaymentInstrumentDataRequest> {
        val paymentInstrumentParams = params.paymentInstrumentParams
        val instrumentDataRequest = MultibancoPaymentInstrumentDataRequest(
            ...
            sessionInfo = MultibancoSessionInfoDataRequest(
