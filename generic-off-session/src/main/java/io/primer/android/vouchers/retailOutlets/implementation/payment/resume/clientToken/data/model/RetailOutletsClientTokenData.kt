...
internal data class RetailOutletsClientTokenData(
    val intent: String,
    ...
    companion object {
        ...
        fun fromString(encoded: String): RetailOutletsClientTokenData {
            ClientTokenDecoder.decode(encoded).let { decoded ->
                return JSONSerializationUtils
                    .getJsonObjectDeserializer<RetailOutletsClientTokenData>()
