...
class FullMandateStringDataTest {
    ...
    fun `should read value from parcel when createFromParcel() is called`() {
        ...
        val fullMandateStringData =
            PrimerStripeOptions.MandateData.FullMandateStringData.CREATOR.createFromParcel(parcel)
    ...
    fun `newArray() should return an array of nulls`() {
        val array = PrimerStripeOptions.MandateData.FullMandateStringData.CREATOR.newArray(5)
