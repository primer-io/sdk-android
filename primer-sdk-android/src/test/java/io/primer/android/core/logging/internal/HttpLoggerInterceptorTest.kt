...
class HttpLoggerInterceptorTest {
    ...
    private val whitelistedBodyKeys: List<WhitelistedKey> = whitelistedKeys {
    ...
    private val pciLocalConfigurationDataSource: LocalConfigurationDataSource by lazy {
        mockk {
            every { getConfigurationNullable() } returns mockk {
    ...
    private fun initInterceptor(
        ...
        localConfigurationDataSource: LocalConfigurationDataSource = mockk {
            every { getConfigurationNullable() } returns null
        },
