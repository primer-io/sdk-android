...
class NolPayLinkPaymentCardDelegateTest {
    @RelaxedMockK
    internal lateinit var nolPayGetLinkPaymentCardTokenInteractor: NolPayGetLinkPaymentCardTokenInteractor

    @RelaxedMockK
    internal lateinit var nolPayGetLinkPaymentCardOTPInteractor: NolPayGetLinkPaymentCardOTPInteractor
