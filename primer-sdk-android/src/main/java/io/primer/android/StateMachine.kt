...
internal class StateMachine<STATE : State, EVENT : Event, SIDE_EFFECT : SideEffect>
private constructor(
    ...
    fun with(init: GraphBuilder<STATE, EVENT, SIDE_EFFECT>.() -> Unit):
    ...
    @Suppress("UNUSED")
    sealed class Transition<STATE : State, EVENT : Event, SIDE_EFFECT : SideEffect> {
        abstract val fromState: STATE
        abstract val event: EVENT

        data class Valid<STATE : State, EVENT : Event, SIDE_EFFECT : SideEffect>
        ...
        data class Invalid<STATE : State, EVENT : Event, SIDE_EFFECT : SideEffect>
        internal constructor(
            override val fromState: STATE,
            override val event: EVENT
        ) : Transition<STATE, EVENT, SIDE_EFFECT>()
    ...
    data class Graph<STATE : State, EVENT : Event, SIDE_EFFECT : SideEffect>(
        ...
        class State<STATE : Any, EVENT : Any, SIDE_EFFECT : Any> internal constructor() {
            ...
            val transitions = linkedMapOf<Matcher<EVENT, EVENT>, (STATE, EVENT) ->
    ...
    class GraphBuilder<STATE : State, EVENT : Event, SIDE_EFFECT : SideEffect>(
