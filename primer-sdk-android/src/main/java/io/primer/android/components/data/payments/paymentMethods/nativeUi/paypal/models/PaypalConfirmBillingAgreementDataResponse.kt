...
internal data class PaypalConfirmBillingAgreementDataResponse(
    ...
    companion object {
        ...
        @JvmField
        val deserializer = JSONObjectDeserializer<PaypalConfirmBillingAgreementDataResponse> { t ->
...
internal data class PaypalShippingAddressDataResponse(
    ...
    companion object {
        ...
        @JvmField
        val serializer = JSONObjectSerializer<PaypalShippingAddressDataResponse> { t ->
            JSONObject().apply {
