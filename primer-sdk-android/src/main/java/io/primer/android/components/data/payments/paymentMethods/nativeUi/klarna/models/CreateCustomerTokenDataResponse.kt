...
internal data class CreateCustomerTokenDataResponse(
    ...
    data class SessionData(
        ...
        companion object {
            ...
            @JvmField
            val serializer = JSONObjectSerializer<SessionData> { t ->
                JSONObject().apply {
            ...
            @JvmField
            val deserializer = JSONObjectDeserializer<SessionData> { t ->
                SessionData(
    ...
    internal data class BillingAddressData(
        ...
        companion object {
            ...
            @JvmField
            val serializer = JSONObjectSerializer<BillingAddressData> { t ->
                JSONObject().apply {
    ...
    data class SessionOrderLines(
        ...
        companion object {
            ...
            @JvmField
            val serializer = JSONObjectSerializer<SessionOrderLines> { t ->
                JSONObject().apply {
    ...
    data class TokenDetailsData(
        ...
        companion object {
            ...
            @JvmField
            val serializer = JSONObjectSerializer<TokenDetailsData> { t ->
                JSONObject().apply {
            ...
            @JvmField
            val deserializer = JSONObjectDeserializer<TokenDetailsData> { t ->
                TokenDetailsData(
