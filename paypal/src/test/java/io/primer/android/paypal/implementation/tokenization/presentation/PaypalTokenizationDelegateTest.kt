...
internal class PaypalTokenizationDelegateTest {
    ...
    @Test
    fun `mapTokenizationData should return correct params for PaypalCheckoutTokenizationInputable`() =
        runTest {
            // Given
            val input =
            ...
            val paymentInstrumentParams =
                tokenizationParams.paymentInstrumentParams
    ...
    @Test
    fun `mapTokenizationData should return correct params for PaypalVaultTokenizationInputable`() =
        runTest {
            // Given
            val input =
