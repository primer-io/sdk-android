...
class PaypalConfirmBillingAgreementInteractorTest {
    ...
    @BeforeEach
    fun setUp() {
        interactor = PaypalConfirmBillingAgreementInteractor(
    ...
    @Test
    fun `performAction() should call confirmBillingAgreement when validation is successful`() = runTest {
        // Given
        val params = mockk<PaypalConfirmBillingAgreementParams> {
