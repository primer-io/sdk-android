...
class PaypalOrderInfoResponseTest {
    ...
    fun `PaypalOrderInfoResponse should deserialize correctly`() {
        ...
        // Assert
        val expectedResponse = PaypalOrderInfoResponse(
            orderId = "order123",
            externalPayerInfo = PaypalExternalPayerInfo(
    ...
    fun `PaypalExternalPayerInfo should deserialize correctly`() {
        ...
        // Assert
        val expectedExternalPayerInfo = PaypalExternalPayerInfo(
            externalPayerId = "payer123",
            email = "email@example.com",
            firstName = "John",
            lastName = "Doe"
    ...
    fun `PaypalOrderInfoResponse should convert to PaypalOrder correctly`() {
        // Arrange
        val response = PaypalOrderInfoResponse(
            orderId = "order123",
            externalPayerInfo = PaypalExternalPayerInfo(
                externalPayerId = "payer123",
                email = "email@example.com",
        ...
        // Assert
        val expectedPaypalOrder = PaypalOrderInfo(
            orderId = "order123",
            email = "email@example.com",
            externalPayerId = "payer123",
