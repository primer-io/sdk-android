...
internal class PaypalCheckoutOrderInfoValidationRulesResolverTest {

    @MockK
    lateinit var orderTokenRule: PaypalValidOrderTokenRule

    private lateinit var resolver: PaypalCheckoutOrderInfoValidationRulesResolver

    @BeforeEach
    fun setUp() {
        MockKAnnotations.init(this)
        resolver = PaypalCheckoutOrderInfoValidationRulesResolver(orderTokenRule)
    }
