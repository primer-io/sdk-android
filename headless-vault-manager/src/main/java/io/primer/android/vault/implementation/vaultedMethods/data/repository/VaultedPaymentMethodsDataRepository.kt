...
internal class VaultedPaymentMethodsDataRepository(
    ...
    override suspend fun getVaultedPaymentMethods(fromCache: Boolean) =
        runSuspendCatching {
            when (fromCache) {
                true -> localVaultedPaymentMethodsDataSource.get()
                false ->
                    configurationDataSource.get().let { configurationData ->
    ...
    override suspend fun deleteVaultedPaymentMethod(id: String) =
        runSuspendCatching {
