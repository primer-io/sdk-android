...
internal class WebRedirectPaymentMethod(private val paymentMethodType: String) :
    ...
    override val module: PaymentMethodModule = object : PaymentMethodModule {
        ...
        override fun registerDependencyContainer(sdkContainers: List<SdkContainer>) {
            sdkContainers.forEach { sdkContainer ->
                sdkContainer.registerContainer(
                    ...
                    container = WebRedirectContainer(
                        sdk = { getSdkContainer() },
        ...
        override fun registerBrandProvider(brandRegistry: BrandRegistry) {
            ...
            brandRegistry.register(paymentMethodType = PaymentMethodType.ADYEN_BANCONTACT_CARD.name, BanContactBrand())
            brandRegistry.register(paymentMethodType = PaymentMethodType.BUCKAROO_BANCONTACT.name, BanContactBrand())
