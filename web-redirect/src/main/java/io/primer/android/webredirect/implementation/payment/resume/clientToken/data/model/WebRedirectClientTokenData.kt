package io.primer.android.webredirect.implementation.payment.resume.clientToken.data.model
...
internal data class WebRedirectClientTokenData(
    val intent: String,
    ...
    companion object {
        ...
        fun fromString(encoded: String): WebRedirectClientTokenData {
            ClientTokenDecoder.decode(encoded).let { decoded ->
                return JSONSerializationUtils
                    .getJsonObjectDeserializer<WebRedirectClientTokenData>()
