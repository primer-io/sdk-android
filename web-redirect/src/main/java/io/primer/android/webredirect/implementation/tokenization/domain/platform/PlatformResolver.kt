...
internal class PlatformResolver : DISdkComponent {
    ...
    fun getPlatform(paymentMethodType: String): String {
        return when (paymentMethodType) {
            PaymentMethodType.ADYEN_VIPPS.toString() -> AdyenVippsMapper(
                cacheConfigurationDataSource = resolve(name = ConfigurationCoreContainer.CACHED_CONFIGURATION_DI_KEY),
                context = resolve()
