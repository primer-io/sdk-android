# Contributing to Primer Android SDK
...
Please read the following guidelines before you [report an issue](https://github.com/primer-io/sdk-android/issues):

1. **Use the GitHub issue search** &mdash; check if the issue has already been
   reported. If it has been, please comment on the existing issue.

2. **Check if the issue has been fixed** &mdash; the latest `main` or
...
> - Primer Android SDK version
> - OS Version (either real device or Emulator)
> - language
...
**[File a bug report](https://github.com/primer-io/sdk-android/issues)**
...
10. [Open a Pull Request](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/creating-a-pull-request) with a
    clear title and description. Our direct Primer Android SDK PR section [link](https://github.com/primer-io/sdk-android)
