...
internal class CardNumberValidatorTest {
    ...
    @Test
    fun `validate should not return error when card number is valid and VISA is supported and source is REMOTE`() =
        runTest {
    ...
    @Test
    fun `validate should not return error when card number is valid and VISA is supported and source is LOCAL_FALLBACK`() =
        runTest {
            val primerCardNumberEntryMetadata = mockk<PrimerCardNumberEntryMetadata>(relaxed = true)
            val primerCardNetworksMetadata = mockk<PrimerCardNetworksMetadata>(relaxed = true)
    ...
    @Test
    fun `validate should not return error when card number is valid source is LOCAL`() =
        runTest {
            val primerCardNumberEntryMetadata = mockk<PrimerCardNumberEntryMetadata>(relaxed = true)
    ...
    @Test
    fun `validate should return error 'invalid-card-type' when card number is valid and VISA is not supported and source is REMOTE`() =
        runTest {
            val primerCardNumberEntryMetadata = mockk<PrimerCardNumberEntryMetadata>(relaxed = true)
            val primerCardNetworksMetadata = mockk<PrimerCardNetworksMetadata>(relaxed = true)
    ...
    @Test
    fun `validate should return error 'invalid-card-type' when card number is valid and VISA is not supported and source is LOCAL_FALLBACK`() =
        runTest {
            val primerCardNumberEntryMetadata = mockk<PrimerCardNumberEntryMetadata>(relaxed = true)
            val primerCardNetworksMetadata = mockk<PrimerCardNetworksMetadata>(relaxed = true)
    ...
    @Test
    fun `validate should return error 'invalid-card-number' when card number is invalid and card network is supported and source is REMOTE`() =
        runTest {
            val primerCardNumberEntryMetadata = mockk<PrimerCardNumberEntryMetadata>(relaxed = true)
            val primerCardNetworksMetadata = mockk<PrimerCardNetworksMetadata>(relaxed = true)
    ...
    @Test
    fun `validate should return error 'invalid-card-number' when card number is invalid and card network is supported and source is LOCAL_FALLBACK`() =
        runTest {
            val primerCardNumberEntryMetadata = mockk<PrimerCardNumberEntryMetadata>(relaxed = true)
            val primerCardNetworksMetadata = mockk<PrimerCardNetworksMetadata>(relaxed = true)
    ...
    @Test
    fun `validate should return error 'invalid-card-number' when metadata source is LOCAL`() =
        runTest {
            val primerCardNumberEntryMetadata = mockk<PrimerCardNumberEntryMetadata>(relaxed = true)
            every { primerCardNumberEntryMetadata.source }.returns(ValidationSource.LOCAL)
            val resultError =
    ...
    @Test
    fun `validate should return error 'invalid-card-number' when metadata cache does not contain value for a given bin`() =
        runTest {
    ...
    @Test
    fun `validate should return error 'invalid-card-number' when metadata cache does contain empty value for a given bin`() =
        runTest {
            val primerCardNumberEntryMetadata = mockk<PrimerCardNumberEntryMetadata>(relaxed = true)
            val primerCardNetworksMetadata = mockk<PrimerCardNetworksMetadata>(relaxed = true)
