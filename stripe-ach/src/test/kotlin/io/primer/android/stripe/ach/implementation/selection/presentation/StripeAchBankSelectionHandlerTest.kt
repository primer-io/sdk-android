...
class StripeAchBankSelectionHandlerTest {
    ...
    @Test
    fun `fetchSelectedBankId() should return error if the Stripe Publishable Key delegate returns error`() = runTest {
    ...
    @Test
    fun `fetchSelectedBankId() should return error if the customer details delegate returns error`() = runTest {
    ...
    @Test
    fun `fetchSelectedBankId() should trigger the bank collection flow`() = runTest {
    ...
    @Test
    fun `fetchSelectedBankId() should return error when bank collection flow is cancelled`() = runTest {
        every { mockConfigurationDelegate.isMockedFlow() } returns false
        every { stripePublishableKeyDelegate.invoke() } returns Result.success("pk")
        val onAdditionalInfoReceivedSlot = slot<AchAdditionalInfo.ProvideActivityResultRegistry>()
        coEvery { checkoutAdditionalInfoHandler.handle(capture(onAdditionalInfoReceivedSlot)) } just Runs
    ...
    @Test
    fun `fetchSelectedBankId() should return error when bank collection flow errors`() = runTest {
        every { mockConfigurationDelegate.isMockedFlow() } returns false
        every { stripePublishableKeyDelegate.invoke() } returns Result.success("pk")
        val onAdditionalInfoReceivedSlot = slot<AchAdditionalInfo.ProvideActivityResultRegistry>()
        coEvery { checkoutAdditionalInfoHandler.handle(capture(onAdditionalInfoReceivedSlot)) } just Runs
    ...
    @Test
    fun `fetchSelectedBankId() should return error when bank collection flow errors but the exception is null`() = runTest {
        every { mockConfigurationDelegate.isMockedFlow() } returns false
        every { stripePublishableKeyDelegate.invoke() } returns Result.success("pk")
        val onAdditionalInfoReceivedSlot = slot<AchAdditionalInfo.ProvideActivityResultRegistry>()
        coEvery { checkoutAdditionalInfoHandler.handle(capture(onAdditionalInfoReceivedSlot)) } just Runs
    ...
    @Test
    fun `fetchSelectedBankId() should return error when bank collection flow returns unknown result code`() = runTest {
        every { mockConfigurationDelegate.isMockedFlow() } returns false
        every { stripePublishableKeyDelegate.invoke() } returns Result.success("pk")
        val onAdditionalInfoReceivedSlot = slot<AchAdditionalInfo.ProvideActivityResultRegistry>()
        coEvery { checkoutAdditionalInfoHandler.handle(capture(onAdditionalInfoReceivedSlot)) } just Runs
    ...
    @Test
    fun `fetchSelectedBankId() should not trigger the bank collection flow when mocking`() = runTest {
