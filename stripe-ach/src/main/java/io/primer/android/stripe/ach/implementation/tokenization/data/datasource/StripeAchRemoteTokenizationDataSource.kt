...
internal class StripeAchRemoteTokenizationDataSource(
    primerHttpClient: PrimerHttpClient,
    apiVersion: () -> PrimerApiVersion,
) : BaseRemoteTokenizationDataSource<StripeAchPaymentInstrumentDataRequest>(primerHttpClient, apiVersion)
