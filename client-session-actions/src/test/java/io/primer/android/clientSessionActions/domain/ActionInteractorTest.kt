...
internal class ActionInteractorTest {
    ...
    fun setUp() {
        ...
        actionInteractor = DefaultActionInteractor(
    ...
    @Test
    fun `invoke with BaseActionUpdateParams should return ClientSessionData from configuration when param list is empty`() = runTest {
    ...
    @Test
    fun `invoke with BaseActionUpdateParams should return ClientSessionData from configuration when param is repeated`() = runTest {
        val primerClientSession = mockk<PrimerClientSession>()
        every { configurationRepository.getConfiguration() } returns mockk {
            every {
                clientSession.clientSessionDataResponse.toClientSessionData().clientSession
        ...
        val params = mockk<MultipleActionUpdateParams> {
    ...
    @Test
    fun `invoke should handle errors`() = runTest {
        val params = mockk<MultipleActionUpdateParams> {
            every { params } returns listOf(mockk())
        }
