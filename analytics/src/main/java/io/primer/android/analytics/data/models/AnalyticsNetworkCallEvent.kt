...
internal data class AnalyticsNetworkCallEvent(
    ...
    override fun copy(newAnalyticsUrl: String?): AnalyticsNetworkCallEvent =
        copy(
    ...
    companion object {
        @JvmField
        val serializer =
            JSONObjectSerializer<AnalyticsNetworkCallEvent> { t ->
...
internal data class NetworkCallProperties(
    ...
    companion object {
        ...
        @JvmField
        val serializer =
            JSONObjectSerializer<NetworkCallProperties> { t ->
                JSONObject().apply {
