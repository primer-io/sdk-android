...
internal class CardPaymentDelegateTest {

    private lateinit var paymentDelegate: CardPaymentDelegate
    private lateinit var resumeHandler: CardResumeHandler
    ...
    fun setUp() {
        ...
        paymentDelegate = CardPaymentDelegate(
    ...
    fun `handleNewClientToken should return success and emit Navigate to Processor 3ds launcher event when continueWithNewClientToken returns a success result`() = runTest {
        // Given
        val clientToken = "testClientToken"
        val decision = CardResumeDecision.CardProcessor3dsResumeDecision(
