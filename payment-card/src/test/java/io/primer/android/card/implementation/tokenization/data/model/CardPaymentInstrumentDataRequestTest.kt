...
internal class CardPaymentInstrumentDataRequestTest {
    ...
    @BeforeEach
    fun setUp() {
        request = CardPaymentInstrumentDataRequest(
    ...
    fun `serializer should handle null cardholderName and preferredNetwork`() {
        // Arrange
        val requestWithNulls = CardPaymentInstrumentDataRequest(
            number = "4111111111111111",
            expirationMonth = "12",
            expirationYear = "2024",
            cvv = "123",
    ...
    fun `serializer should handle empty strings`() {
        // Arrange
        val requestWithEmptyFields = CardPaymentInstrumentDataRequest(
            number = "",
            expirationMonth = "",
            expirationYear = "",
            cvv = "",
