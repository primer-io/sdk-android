...
internal class HttpLoggerInterceptorTest {
    private val rawBody =
        JSONObject(
            """
            {
               "customerId":null,
               "orderId":"android-test-356e6b98-07a3-4b2a-9857-1a5f7c553818",
               "amount":1000,
               "currencyCode":"EUR",
               "order":{
                  "countryCode":"NL",
