...
class TemplateMandateDataTest {
    ...
    fun `should read merchant name from parcel when createFromParcel() is called`() {
        ...
        val mandateData = PrimerStripeOptions.MandateData.TemplateMandateData.createFromParcel(parcel)
    ...
    fun `newArray() should return an array of nulls`() {
        val array = PrimerStripeOptions.MandateData.TemplateMandateData.newArray(5)
