...
class FullMandateDataTest {
    ...
    fun `should read value from parcel when createFromParcel() is called`() {
        ...
        val fullMandateData = PrimerStripeOptions.MandateData.FullMandateData.createFromParcel(parcel)
    ...
    fun `newArray() should return an array of nulls`() {
        val array = PrimerStripeOptions.MandateData.FullMandateData.newArray(5)
