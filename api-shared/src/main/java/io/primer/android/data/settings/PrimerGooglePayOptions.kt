...
data class GooglePayButtonOptions(
    ...
    internal companion object {
        ...
        @JvmField
        val serializer =
            JSONObjectSerializer<GooglePayButtonOptions> { t ->
                JSONObject().apply {
        ...
        @JvmField
        val CREATOR =
            object : Parcelable.Creator<GooglePayButtonOptions> {
...
constructor(
    ...
    """
        ...
        @JvmField
        val CREATOR =
            object : Parcelable.Creator<PrimerGooglePayOptions> {
        ...
        @JvmField
        val serializer =
            JSONObjectSerializer<PrimerGooglePayOptions> { t ->
                JSONObject().apply {
...
data class PrimerGoogleShippingAddressParameters(
    ...
    internal companion object {
        ...
        @JvmField
        val serializer =
            JSONObjectSerializer<PrimerGoogleShippingAddressParameters> { t ->
                JSONObject().apply {
        ...
        @JvmField
        val CREATOR =
            object : Parcelable.Creator<PrimerGoogleShippingAddressParameters> {
